...
import com.neeldeshmukh.vpn.Utils.CheckInternetConnection;
import com.neeldeshmukh.vpn.Utils.SharedPreferencesc;
import com.neeldeshmukh.vpn.databinding.FragmentMainBinding;
...
public class MainFragment extends Fragment implements View.OnClickListener, ChangeServer {
    ...
    private SharedPreferencesc preference;
    ...
    private void initializeAll() {
        ...
        preference = new SharedPreferencesc(getContext());
    ...
    public void setStatus(String connectionState) {
        ...
        switch (connectionState) {
            case "DISCONNECTED":
                ...
                //binding.logTv.setText("Connected Securely");
